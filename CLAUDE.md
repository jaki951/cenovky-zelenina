...
- **Palette:** kraft/cream background, dark forest-green header band, cream
  text on the band. **No red anywhere** — red is reserved for sale/discount
...
- **Product name:** cream text on the dark green band. Font: **Oswald**,
  ...
  flagged as either illegible or too stiff; Oswald — a bold sans — was the
  fix. If revisiting the name font, avoid script/italic serifs.)
...
- Edit the exact named file in place. Don't branch into new/differently
  named files for iterations.
...
- The user iterates fast and often in short messages ("try another font",
  ...
  concrete, reasonable choice and ship it rather than asking a lot of
  clarifying questions; they'll give quick feedback if it's wrong.
